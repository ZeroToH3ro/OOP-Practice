...
public class Main {
	public static void main(String[] args) {
		...
		while (true) {
			...
			System.out.println("Enter 1: To insert People for rent");
			System.out.println("Enter 2: To remove People by passport");
			...
			case "1": {
				...
				People People = new People(name, age, passport, room, numberRent);
				hotel.add(People);
				scanner.nextLine();
				break;
			}
